...
const i18n = {
  ar: {
    nav_home: '🏠 الرئيسية', nav_programs: '🎓 البرامج',
    nav_teachers: '👨‍🏫 الأساتذة', nav_paths: '🗺️ المسارات',
    nav_how: '📋 كيف تنضم', nav_ann: '📢 الإعلانات',
    nav_faq: '❓ الأسئلة الشائعة', nav_contact: '📍 انضم لفريقنا',
    nav_cta: '✦ سجّل الآن',
    topbar_text: '🎓 التسجيل في المخيم الصيفي متاح الآن',
    topbar_sub: 'قمار، الوادي — مركز التميز التعليمي',
    ...
    btn5: 'دورات أونلاين', btn6: 'دورات تكوينية',
    btn_summer: '🏕️ المخيم الصيفي', btn5_short: 'أونلاين',
    ...
    hero_check1: 'متابعة مستمرة للطلاب', hero_check2: 'أساتذة أكفاء وخطط واضحة',
    hero_check3: 'مستويات مناسبة لكل الأعمار', hero_check4: 'دروس حضورية وأونلاين',
    stat_students: 'طالب مسجّل', stat_teachers: 'أستاذ متخصص',
    stat_years: 'سنوات خبرة', stat_success: '% معدل النجاح',
    ach1: 'مركز معتمد', ach2: 'لغات متعددة',
    ach3: 'تعلّم أونلاين', ach4: 'تقييم ممتاز', ach5: 'نتائج مضمونة',
    trust1_title: 'أساتذة مؤهّلون', trust1_desc: 'مدرّسون ذوو خبرة ومهارة عالية',
    trust2_title: 'جداول مرنة', trust2_desc: 'برامج متكيفة مع احتياجاتك',
    trust3_title: 'منهج حديث', trust3_desc: 'تعلّم تفاعلي وفعّال',
    trust4_title: 'متابعة ودعم', trust4_desc: 'مراقبة مستمرة وتوجيه دائم',
    div1_title: 'انضم لآلاف الطلاب الناجحين',
    div1_desc: 'تجربة تعليمية حقيقية تبدأ بخطوة واحدة', div1_btn: '✦ سجّل الآن',
    div2_title: '🗺️ مسيرتك التعليمية تبدأ من هنا',
    div2_desc: 'اختر مسارك وابدأ رحلة التميز مع أفضل المدرّسين',
    div3_title: '🏆 لماذا E-PLUS؟',
    div3_desc: 'لأننا نؤمن أن كل طالب يستحق أفضل تجربة تعليمية ممكنة',
    div4_title: '💬 ماذا يقول طلابنا؟',
    div4_desc: 'آراء حقيقية من طلاب حقيقيين أثبتوا التميز',
    sec_programs_pre: '🎓 برامجنا',
    sec_programs_title: 'اختر ما يناسب أهدافك',
    sec_programs_desc: 'اختر البرنامج الذي يناسب مستواك وهدفك، وابدأ رحلة تعليمية منظمة وواضحة.',
    prog1_name: 'دورات اللغات', prog1_desc: 'تعلم الإنجليزية والفرنسية وغيرهما عبر مستويات متدرجة وتطبيق عملي مستمر.',
    prog2_name: 'الدعم الدراسي', prog2_desc: 'حصص مرافقة ومراجعة للطلاب مع تنظيم، متابعة، وتقوية في المواد الأساسية.',
    prog3_name: 'دروس VIP', prog3_desc: 'تعليم فردي أو بمجموعات صغيرة جداً مع تركيز كامل على احتياج الطالب.',
    prog4_name: 'IELTS', prog4_desc: 'برنامج متخصص لتقوية المهارات الأربع وفهم بنية الاختبار والتدريب عليه.',
    prog5_name: 'دورات أونلاين', prog5_desc: 'تعلم من أي مكان عبر حصص مباشرة ومحتوى منظم ومتابعة رقمية.',
    prog6_name: 'دورات تكوينية', prog6_desc: 'برامج مهارية وتكوينية تساعدك على تطوير نفسك أكاديمياً ومهنياً.',
    prog_cta: 'سجّل الآن ✦',
    sec_paths_pre: '🗺️ المسارات', sec_paths_title: 'اختر مسارك',
    sec_paths_desc: 'اختر المسار الذي يناسب عمرك، مستواك، وهدفك الدراسي أو اللغوي.',
    path1_title: 'المبتدئ', path1_desc: 'بناء أساس قوي في اللغة والتعلّم بأسلوب ممتع وتفاعلي.',
    path1_f1: 'مستوى أساسي', path1_f2: 'تعلّم تفاعلي', path1_f3: 'متابعة مستمرة',
    path2_title: 'الدعم الدراسي', path2_desc: 'مرافقة دراسية حقيقية وتحسين النتائج مع متابعة دورية.',
    path2_f1: 'مراجعة شاملة', path2_f2: 'تقوية المواد', path2_f3: 'تقارير دورية',
    path3_title: 'المتقدم', path3_desc: 'تطوير لغوي ومهاري يناسب الدراسة، العمل، والسفر.',
    path3_f1: 'مستوى متقدم', path3_f2: 'تحضير IELTS', path3_f3: 'شهادات معتمدة',
    path_btn: 'ابدأ الآن',
    sec_how_pre: '📋 كيف تنضم', sec_how_title: 'خطوات بسيطة وواضحة',
    sec_how_desc: 'خطوات بسيطة وواضحة للبدء في البرنامج المناسب لك.',
    step1_title: 'تواصل معنا', step1_desc: 'راسلنا أو زر المركز لمعرفة البرامج المتاحة.',
    step2_title: 'اختر برنامجك', step2_desc: 'نساعدك على اختيار المسار أو البرنامج الأنسب.',
    step3_title: 'سجّل', step3_desc: 'أكمل معلوماتك وثبّت مقعدك في البرنامج.',
    step4_title: 'ابدأ التعلّم', step4_desc: 'انطلق ضمن تجربة تعليمية حديثة ومتكاملة.',
    sec_why_pre: '⭐ لماذا E-PLUS', sec_why_title: 'تجربة مختلفة',
    sec_why_desc: 'نعمل على تقديم تجربة منظمة، أنيقة، وعملية تساعد الطالب على التقدم بثقة.',
    why_main_title: 'هدفنا نجاحك',
    why_main_desc: 'نعمل على تقديم تجربة منظمة، أنيقة، وعملية تساعد الطالب على التقدم بثقة.',
    why_p1: 'طاقم متميز يعمل على تقديم تعليم منظم وفعال بمستوى احترافي.',
    why_p2: 'خبرة في تأسيس وتطوير المهارات اللغوية بأسلوب تفاعلي حديث.',
    why_p3: 'مرافقة دراسية ومتابعة منهجية لتحسين الفهم والتحصيل.',
    why_p4: 'تركيز على استراتيجيات الاختبار والتدريب العملي الموجّه.',
    why_p5: 'برامج شخصية مخصصة حسب المستوى والاحتياج والأهداف.',
    mini1_title: 'أساتذة خبراء', mini1_desc: 'فريق من المدرّسين المتخصصين والمدرّبين.',
    mini2_title: 'نتائج ملموسة', mini2_desc: '96% من طلابنا يُحقّقون تقدماً واضحاً.',
    mini3_title: 'بيئة احترافية', mini3_desc: 'قاعات حديثة ومجهّزة بأحدث الوسائل.',
    mini4_title: 'دعم مستمر', mini4_desc: 'متابعة منتظمة وتواصل دائم مع أولياء الأمور.',
    sec_teachers_pre: '👨‍🏫 فريقنا', sec_teachers_title: 'أساتذة خبراء ومتفانون',
    teach_math: 'رياضيات', teach_phys: 'فيزياء وتكنولوجيا',
    teach_eng: 'اللغة الإنجليزية', teach_fr: 'اللغة الفرنسية',
    teach_ar: 'اللغة العربية', teach_bio: 'علوم طبيعية',
    teach_desc1: 'خبرة في تأسيس وتطوير المهارات الرياضية بأسلوب تفاعلي حديث.',
    teach_desc2: 'تركيز على استراتيجيات الاختبار والتدريب العملي الموجّه.',
    teach_desc3: 'برامج شخصية مخصصة حسب المستوى والاحتياج والأهداف.',
    teach_desc4: 'مرافقة دراسية ومتابعة منهجية لتحسين الفهم والتحصيل.',
    teach_desc5: 'طاقم متميز يعمل على تقديم تعليم منظم وفعال.',
    teach_desc6: 'خبرة واسعة في تقديم مفاهيم العلوم بطريقة مبسّطة وفعّالة.',
    sec_test_pre: '💬 آراء الطلاب', sec_test_title: 'ماذا يقول طلابنا',
    test1: '"تجربة جميلة ومنظمة، والأساتذة متعاونون جداً والطريقة واضحة ومحفزة."',
    test2: '"الدعم الدراسي ساعد ابني على تنظيم مراجعته وفهم الدروس بشكل أعمق وواضح."',
    test3: '"درست IELTS في المركز وكانت النتائج أفضل من توقعاتي. الأستاذ محترف جداً."',
    test4: '"دروس VIP غيّرت مستواي في الإنجليزية خلال أسابيع. اهتمام شخصي وخطة مخصصة."',
    ann_pre: '📢 أخبار المركز', annTitle: 'إعلانات المركز التعليمي',
    ann_live: 'مباشر · يتم تحديث الإعلانات تلقائياً',
    summer_title: 'المخيم الصيفي — Summer Plus 5th Edition',
    summer_desc: 'تجربة صيفية تعليمية ترفيهية لا تُنسى. سجّل الآن واحجز مقعدك!',
    summer_btn: '🏕️ سجّل في المخيم',
    sec_faq_pre: '❓ الأسئلة الشائعة', sec_faq_title: 'أسئلة شائعة',
    faq1_q: '📍 أين يقع المركز؟', faq1_a: 'يقع مركز E-PLUS في قمار، الوادي — الجزائر.',
    faq2_q: '📅 ما هي أوقات الدراسة؟', faq2_a: 'يوفر المركز جداول مرنة صباحية ومسائية تناسب جميع المراحل.',
    faq3_q: '💰 كيف أعرف الأسعار؟', faq3_a: 'يمكنك التواصل معنا مباشرة عبر واتساب أو زيارة المركز للاستفسار عن الأسعار.',
    faq4_q: '🌐 هل توجد دروس أونلاين؟', faq4_a: 'نعم، نقدم حصصاً أونلاين عبر منصات تعليمية مباشرة مع متابعة رقمية منتظمة.',
    faq5_q: '🎓 هل يوجد شهادات؟', faq5_a: 'يحصل الطلاب على شهادات إتمام البرامج والدورات من المركز.',
    sec_contact_pre: '📍 تواصل معنا', sec_contact_title: 'نحن هنا لمساعدتك',
    sec_contact_desc: 'يسعدنا استقبال استفساراتكم ومساعدتكم في اختيار البرنامج الأنسب.',
    contact_info_title: '📬 معلومات التواصل',
    contact_loc: 'الموقع', contact_phone: 'الهاتف',
    contact_hours: '🕐 أوقات العمل', days_sat_thu: 'السبت — الخميس',
    day_fri: 'الجمعة', closed: 'مغلق',
    contact_wa: 'واتساب',
    join_title: '🤝 انضم لفريقنا',
    join_desc: 'نرحب بالأساتذة، المؤطرين، والمبدعين الراغبين في المساهمة في تجربة تعليمية مميزة.',
    join_note: 'أرسل لنا سيرتك الذاتية عبر البريد الإلكتروني أو واتساب.',
    join_btn: '📨 تواصل معنا الآن',
    footer_copy: '© 2026 E-PLUS Center — جميع الحقوق محفوظة',
    loading_title: 'جاري المعالجة...', loading_msg: 'يرجى الانتظار',
    success_title: 'تم التسجيل بنجاح', success_close: 'حسناً',
    lang_warn_ar: 'يرجى إدخال جميع المعلومات باللغة العربية فقط',
    // FORM
    ...
    optional: '(اختياري)', eduLevel: 'المستوى الدراسي',
    ...
    levelTest: 'هل تريد إجراء اختبار تحديد المستوى؟', yes: 'نعم', no: 'لا',
    ...
    supportType_label: 'نوع الدعم', support_pres: '🏫 حضوري', support_online: '💻 أونلاين',
    profession_label: 'المهنة / الهدف',
    day_per_week: 'يوم/أسبوع', days_per_week: 'أيام/أسبوع',
  ...
  en: {
    // NAV
    nav_home: '🏠 Home', nav_programs: '🎓 Programs',
    nav_teachers: '👨‍🏫 Teachers', nav_paths: '🗺️ Paths',
    nav_how: '📋 How to Join', nav_ann: '📢 Announcements',
    nav_faq: '❓ FAQ', nav_contact: '📍 Join Our Team',
    nav_cta: '✦ Register Now',
    // TOPBAR
    topbar_text: '🎓 Summer Camp Registration is Now Open',
    topbar_sub: 'Ouargla-Oued — Excellence Education Center',
    // HERO
    title: 'Your first destination for education and growth',
    hero_tag: '✦ Excellence Education Center · Ouargla, Oued ✦',
    subtitle: 'Register for courses and educational programs',
    btn1: '📚 Academic Support', btn2: 'Language Courses',
    btn3: 'VIP Lessons', btn4: 'IELTS Test',
    btn5: 'Online Courses', btn6: 'Training Programs',
    btn_summer: '🏕️ Summer Camp', btn5_short: 'Online',
    hero_card_kicker: 'E-PLUS EXPERIENCE',
    hero_card_title: 'Quality, Clarity & Results',
    hero_card_desc: 'Diverse programs for languages, academic support, exam preparation, and individual learning in a modern environment.',
    hero_check1: 'Continuous student follow-up', hero_check2: 'Qualified teachers and clear plans',
    hero_check3: 'Levels suitable for all ages', hero_check4: 'In-person and online lessons',
    // STATS
    stat_students: 'Enrolled Students', stat_teachers: 'Specialist Teachers',
    stat_years: 'Years of Experience', stat_success: '% Success Rate',
    // ACHIEVEMENTS
    ach1: 'Certified Center', ach2: 'Multiple Languages',
    ach3: 'Online Learning', ach4: 'Excellent Rating', ach5: 'Guaranteed Results',
    // TRUST
    trust1_title: 'Qualified Teachers', trust1_desc: 'Experienced and highly skilled instructors',
    trust2_title: 'Flexible Schedules', trust2_desc: 'Programs adapted to your needs',
    trust3_title: 'Modern Approach', trust3_desc: 'Interactive and effective learning',
    trust4_title: 'Follow-up & Support', trust4_desc: 'Continuous monitoring and guidance',
    // DIVIDERS
    div1_title: 'Join thousands of successful students',
    div1_desc: 'A real educational experience starts with one step', div1_btn: '✦ Register Now',
    div2_title: '🗺️ Your educational journey starts here',
    div2_desc: 'Choose your path and begin excellence with the best teachers',
    div3_title: '🏆 Why E-PLUS?',
    div3_desc: 'Because we believe every student deserves the best possible educational experience',
    div4_title: '💬 What do our students say?',
    div4_desc: 'Real reviews from real students who proved their excellence',
    // PROGRAMS
    sec_programs_pre: '🎓 Our Programs',
    sec_programs_title: 'Choose what fits your goals',
    ...
    // PATHS
    sec_paths_pre: '🗺️ Learning Paths', sec_paths_title: 'Choose your path',
    sec_paths_desc: 'Choose the path that suits your age, level, and educational or language goal.',
    path1_title: 'Beginner', path1_desc: 'Build a strong foundation in language and learning with a fun and interactive style.',
    path1_f1: 'Basic level', path1_f2: 'Interactive learning', path1_f3: 'Continuous follow-up',
    path2_title: 'Academic Support', path2_desc: 'Real academic support and improved results with regular monitoring.',
    path2_f1: 'Comprehensive review', path2_f2: 'Subject reinforcement', path2_f3: 'Regular reports',
    path3_title: 'Advanced', path3_desc: 'Language and skill development suitable for study, work, and travel.',
    path3_f1: 'Advanced level', path3_f2: 'IELTS preparation', path3_f3: 'Recognized certificates',
    path_btn: 'Start Now',
    // STEPS
    sec_how_pre: '📋 How to Join', sec_how_title: 'Simple and clear steps',
    sec_how_desc: 'Simple and clear steps to start the right program for you.',
    step1_title: 'Contact Us', step1_desc: 'Message us or visit the center to learn about available programs.',
    step2_title: 'Choose Your Program', step2_desc: 'We help you choose the right path or program.',
    step3_title: 'Register', step3_desc: 'Complete your information and confirm your spot.',
    step4_title: 'Start Learning', step4_desc: 'Begin a modern and complete educational experience.',
    // WHY
    sec_why_pre: '⭐ Why E-PLUS', sec_why_title: 'A different experience',
    sec_why_desc: 'We provide an organized, elegant and practical experience that helps students progress with confidence.',
    why_main_title: 'Our goal is your success',
    why_main_desc: 'We provide an organized, elegant and practical experience that helps students progress with confidence.',
    why_p1: 'An outstanding team delivering organized and effective education at a professional level.',
    why_p2: 'Expertise in building and developing language skills with a modern interactive approach.',
    why_p3: 'Academic support and systematic follow-up to improve understanding and achievement.',
    why_p4: 'Focus on exam strategies and practical guided training.',
    why_p5: 'Personalized programs tailored to each student's level, needs, and goals.',
    mini1_title: 'Expert Teachers', mini1_desc: 'A team of specialized and trained instructors.',
    mini2_title: 'Tangible Results', mini2_desc: '96% of our students achieve clear progress.',
    mini3_title: 'Professional Environment', mini3_desc: 'Modern classrooms equipped with the latest tools.',
    mini4_title: 'Continuous Support', mini4_desc: 'Regular follow-up and constant communication with parents.',
    // TEACHERS
    sec_teachers_pre: '👨‍🏫 Our Team', sec_teachers_title: 'Expert and dedicated teachers',
    teach_math: 'Mathematics', teach_phys: 'Physics & Technology',
    teach_eng: 'English Language', teach_fr: 'French Language',
    teach_ar: 'Arabic Language', teach_bio: 'Natural Sciences',
    teach_desc1: 'Expertise in building and developing mathematical skills with a modern interactive approach.',
    teach_desc2: 'Focus on exam strategies and practical guided training.',
    teach_desc3: 'Personalized programs tailored to each student's level, needs, and goals.',
    teach_desc4: 'Academic support and systematic follow-up to improve understanding and achievement.',
    teach_desc5: 'An outstanding team delivering organized and effective education.',
    teach_desc6: 'Extensive experience in presenting science concepts in a simplified and effective way.',
    // TESTIMONIALS
    sec_test_pre: '💬 Student Reviews', sec_test_title: 'What our students say',
    test1: '"A great and organized experience. Teachers are very cooperative and the method is clear and motivating."',
    test2: '"Academic support helped my son organize his revision and understand lessons more deeply."',
    test3: '"I studied IELTS at the center and the results were better than expected. Very professional teacher."',
    test4: '"VIP lessons transformed my English level in weeks. Personal attention and a custom plan."',
    // ANNOUNCEMENTS
    ann_pre: '📢 Center News', annTitle: 'Center Announcements',
    ann_live: 'Live · Announcements update automatically',
    // SUMMER
    summer_title: 'Summer Camp — Summer Plus 5th Edition',
    summer_desc: 'An unforgettable educational and fun summer experience. Register now and reserve your spot!',
    summer_btn: '🏕️ Join the Camp',
    // FAQ
    sec_faq_pre: '❓ FAQ', sec_faq_title: 'Frequently Asked Questions',
    faq1_q: '📍 Where is the center located?', faq1_a: 'E-PLUS Center is located in Ouargla, Oued — Algeria.',
    faq2_q: '📅 What are the study hours?', faq2_a: 'The center offers flexible morning and evening schedules suitable for all levels.',
    faq3_q: '💰 How do I know the prices?', faq3_a: 'You can contact us directly via WhatsApp or visit the center to inquire about prices.',
    faq4_q: '🌐 Are there online lessons?', faq4_a: 'Yes, we offer online sessions via live educational platforms with regular digital follow-up.',
    faq5_q: '🎓 Are there certificates?', faq5_a: 'Students receive completion certificates for programs and courses from the center.',
    // CONTACT
    sec_contact_pre: '📍 Contact Us', sec_contact_title: 'We are here to help you',
    sec_contact_desc: 'We are happy to receive your inquiries and help you choose the right program.',
    contact_info_title: '📬 Contact Information',
    contact_loc: 'Location', contact_phone: 'Phone',
    contact_hours: '🕐 Working Hours', days_sat_thu: 'Saturday — Thursday',
    day_fri: 'Friday', closed: 'Closed',
    contact_wa: 'WhatsApp',
    join_title: '🤝 Join Our Team',
    join_desc: 'We welcome teachers, trainers, and creative minds who want to contribute to an outstanding educational experience.',
    join_note: 'Send us your CV via email or WhatsApp.',
    join_btn: '📨 Contact Us Now',
    footer_copy: '© 2026 E-PLUS Center — All Rights Reserved',
    loading_title: 'Processing...', loading_msg: 'Please wait',
    success_title: 'Registration completed successfully', success_close: 'OK',
    lang_warn_en: 'Please enter all information in English only',
    // FORM
    ...
    motivationVip: 'What led you to choose the VIP private lessons system?',
    optional: '(optional)', eduLevel: 'Education Level',
    ...
    levelTest: 'Would you like a level placement test?', yes: 'Yes', no: 'No',
    ...
    supportType_label: 'Support Type', support_pres: '🏫 In-Person', support_online: '💻 Online',
    profession_label: 'Profession / Goal',
    day_per_week: 'day/week', days_per_week: 'days/week',

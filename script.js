...
const i18n = {
  ar: {
    ...
    hero_btn_lang_journey: 'ابدأ رحلتك في اللغات',
  ...
  en: {
    ...
    hero_btn_lang_journey: 'Start Your Language Journey',
  ...
  fr: {
    ...
    hero_btn_lang_journey: 'Commencez votre voyage linguistique',
...
const specialties = {
  ...
  'ثانية ثانوي': ['علوم تجريبية', 'آداب ولغات', 'تقني رياضي', 'تسيير واقتصاد'],
...
const curriculum = {
  ...
  'رابعة متوسط': [
    ...
    { subject: 'علوم الطبيعة والحياة', teachers: ['الأستاذة شيخة زكرياء'] }
  ],
  'أولى ثانوي|علوم تجريبية': [
    { subject: 'اللغة الفرنسية', teachers: ['الأستاذة كروش شمس الهدى'] },
    { subject: 'العلوم الفيزيائية', teachers: ['الأستاذ لكموته لمين'] }
  ],
  ...
  'ثالثة ثانوي (بكالوريا)|تسيير واقتصاد': [
    ...
    { subject: 'تاريخ وجغرافيا', teachers: ['الأستاذ ايمن دخان'] },
    { subject: 'العلوم الإسلامية', teachers: ['الأستاذ هبيتة ربيع'] },
    { subject: 'الرياضيات', teachers: ['الأستاذ حاصي فريد'] }
  ],
  ...
  'ثالثة ثانوي (بكالوريا)|لغات أجنبية': [
    ...
    { subject: 'اللغة الألمانية', teachers: ['الأستاذ علالي حمزة'] },
    { subject: 'اللغة العربية', teachers: ['الأستاذة موساوي زبيدة'] },
    { subject: 'اللغة الفرنسية', teachers: ['الأستاذة كروش شمس الهدى'] },
    { subject: 'اللغة الإنجليزية', teachers: ['الأستاذ كرام الصادق'] },

...
const i18n = {
  ...
  en: {
    ...
    why_p5: 'Personalized programs tailored to each student level, needs, and goals.',
    ...
    teach_desc3: 'Personalized programs tailored to each student level, needs, and goals.',

...
const i18n = {
  ar: {
    ...
    // Hero
    topbar_camp: '📚 التسجيلات الأولية للدعم المدرسي مفتوحة الآن — المقاعد محدودة',
    // Hero
    hero_tag: '🟡 التسجيلات الأولية مفتوحة الآن',
    hero_title: 'بدأت التسجيلات الأولية لبرنامج<br />الدعم المدرسي <span class="ep-text-gold">للموسم 2026 / 2027</span>',
    hero_subtitle: 'المقاعد محدودة — أساتذة متميزون — متابعة مستمرة لكل تلميذ.<br />سجّل الآن واحجز مقعدك في أفضل برنامج دعم دراسي بالوادي.',
  ...
  en: {
    ...
    topbar_camp: '📚 Academic support registration is now open — Limited seats',
    hero_tag: '🟡 Registration is now open',
    hero_title: 'Academic Support Program<br />Registration <span class="ep-text-gold">2026 / 2027</span>',
    hero_subtitle: 'Limited seats — Expert teachers — Continuous student follow-up.<br />Register now and secure your spot in the best academic support program in El Oued.',
  ...
  fr: {
    ...
    topbar_camp: '📚 Inscriptions au soutien scolaire ouvertes — Places limitées',
    hero_tag: '🟡 Inscriptions ouvertes maintenant',
    hero_title: 'Inscriptions au Programme<br />de Soutien Scolaire <span class="ep-text-gold">2026 / 2027</span>',
    hero_subtitle: 'Places limitées — Enseignants qualifiés — Suivi continu de chaque élève.<br />Inscrivez-vous maintenant et réservez votre place dans le meilleur programme de soutien scolaire.',

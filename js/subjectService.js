...
const SubjectService = (function () {
  ...
  const SUBJECTS_BY_LEVEL = {
    ...
    'السنة الثالثة ثانوي (بكالوريا)': {
      'علوم تجريبية': ['العلوم الفيزيائية والتكنولوجيا', 'الرياضيات', 'علوم الطبيعة والحياة', 'اللغة العربية', 'اللغة الفرنسية', 'اللغة الإنجليزية', 'العلوم الإسلامية ( دورة )', 'التاريخ ( دورة )'],
      'رياضيات': ['العلوم الفيزيائية', 'الرياضيات', 'اللغة العربية', 'اللغة الإنجليزية', 'العلوم الإسلامية ( دورة )', 'التاريخ ( دورة )', 'الفلسفة'],
      'تسيير واقتصاد': ['اللغة العربية', 'اللغة الإنجليزية', 'المحاسبة', 'اقتصاد وقانون', 'العلوم الإسلامية ( دورة )', 'التاريخ ( دورة )', 'الفلسفة'],
      'تقني رياضي': ['العلوم الفيزيائية', 'الرياضيات', 'اللغة الإنجليزية', 'العلوم الإسلامية ( دورة )', 'التاريخ ( دورة )'],
      'آداب ولغات': ['اللغة العربية', 'الفلسفة', 'اللغة الفرنسية', 'اللغة الإنجليزية', 'اللغة الألمانية', 'اللغة الإسبانية', 'العلوم الإسلامية ( دورة )', 'التاريخ ( دورة )']
    }
  };

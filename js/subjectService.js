...
const SubjectService = (function () {
  ...
  const SUBJECTS_BY_LEVEL = {
    ...
    'السنة الثالثة ثانوي (بكالوريا)': {
      'علوم تجريبية': ['العلوم الفيزيائية والتكنولوجيا', 'الرياضيات', 'علوم الطبيعة والحياة', 'اللغة العربية', 'اللغة الفرنسية', 'اللغة الإنجليزية', 'العلوم الإسلامية', 'الاجتماعيات'],
      'رياضيات': ['العلوم الفيزيائية', 'الرياضيات', 'اللغة العربية', 'اللغة الإنجليزية', 'العلوم الإسلامية', 'الاجتماعيات', 'الفلسفة'],
      'تسيير واقتصاد': ['اللغة العربية', 'اللغة الإنجليزية', 'المحاسبة', 'اقتصاد وقانون', 'العلوم الإسلامية', 'الاجتماعيات', 'الفلسفة'],
      'تقني رياضي': ['العلوم الفيزيائية', 'الرياضيات', 'اللغة الإنجليزية', 'العلوم الإسلامية', 'الاجتماعيات'],

...
const SubjectService = (function () {
  ...
  const SUBJECTS_BY_LEVEL = {
    ...
    'السنة الثالثة ثانوي (بكالوريا)': {
      'علوم تجريبية': ['العلوم الفيزيائية والتكنولوجيا', 'الرياضيات', 'علوم الطبيعة والحياة', 'اللغة العربية', 'اللغة الإنجليزية', 'اللغة الإنجليزية ( دورة )', 'العلوم الإسلامية ( دورة )', 'التاريخ ( دورة )', 'الفلسفة'],
      ...
      'آداب ولغات': ['اللغة العربية', 'الفلسفة', 'اللغة الفرنسية', 'اللغة الإنجليزية', 'اللغة الإنجليزية ( دورة )', 'اللغة الألمانية', 'اللغة الإسبانية', 'الرياضيات', 'العلوم الإسلامية ( دورة )', 'التاريخ ( دورة )']
    },
    'السنة الأولى ثانوي': {

...
const SUPPORT_STREAMS = {
  'علوم تجريبية': [
    ...
    { subject: 'اجتماعيات ( دورة )', teacher: 'أيمن دخان' },
  ...
  'تسيير واقتصاد': [
    ...
    { subject: 'اجتماعيات ( دورة )', teacher: 'أيمن دخان' },
    { subject: 'الفلسفة', teacher: 'دادة نجاح سلام' },
    { subject: 'الرياضيات', teacher: 'حاصي فريد' },
  ],
  'تقني رياضي': [
    { subject: 'العلوم الفيزيائية', teacher: 'نمسي عبد الرحمان' },
    { subject: 'العلوم الفيزيائية', teacher: 'لكموته لمين' },
...
const SubjectService = (function () {
  ...
  const SUBJECTS_BY_LEVEL = {
    ...
    'السنة الثالثة ثانوي (بكالوريا)': {
      'علوم تجريبية': ['العلوم الفيزيائية والتكنولوجيا', 'الرياضيات', 'علوم الطبيعة والحياة', 'اللغة العربية', 'اللغة الإنجليزية', 'اللغة الإنجليزية ( دورة )', 'العلوم الإسلامية ( دورة )', 'اجتماعيات ( دورة )', 'الفلسفة'],
      'رياضيات': ['العلوم الفيزيائية', 'الرياضيات', 'اللغة العربية', 'اللغة الإنجليزية', 'اللغة الإنجليزية ( دورة )', 'العلوم الإسلامية ( دورة )', 'اجتماعيات ( دورة )', 'الفلسفة'],
      'تسيير واقتصاد': ['اللغة العربية', 'اللغة الإنجليزية', 'اللغة الإنجليزية ( دورة )', 'المحاسبة', 'اقتصاد وقانون', 'العلوم الإسلامية ( دورة )', 'اجتماعيات ( دورة )', 'الفلسفة', 'الرياضيات'],
      'تقني رياضي': ['العلوم الفيزيائية', 'الرياضيات', 'اللغة الإنجليزية', 'اللغة الإنجليزية ( دورة )', 'العلوم الإسلامية ( دورة )', 'اجتماعيات ( دورة )'],
      ...
      'آداب وفلسفة': ['اللغة العربية', 'الفلسفة', 'اللغة الفرنسية', 'اللغة الإنجليزية', 'اللغة الإنجليزية ( دورة )', 'اللغة الألمانية', 'اللغة الإسبانية', 'الرياضيات', 'العلوم الإسلامية ( دورة )', 'اجتماعيات ( دورة )']
    },
    'السنة الأولى ثانوي': {
    ...
    'السنة الثانية ثانوي': {
      'علوم تجريبية': ['اللغة الفرنسية', 'العلوم الفيزيائية', 'علوم الطبيعة والحياة', 'الرياضيات'],
      'آداب ولغات': ['اللغة الفرنسية', 'الفلسفة', 'اللغة الإسبانية', 'اللغة الألمانية'],
      'آداب وفلسفة': ['اللغة الفرنسية', 'الفلسفة', 'اللغة الإسبانية', 'اللغة الألمانية'],
  ...
  const _SOCIAL_KEYS = new Set(['الاجتماعيات', 'التاريخدورة', 'تاريخوجغرافيا', 'التاريخ', 'اجتماعياتدورة']);
